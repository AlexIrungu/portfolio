        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between mb-5">
            <div className="flex-grow md:mr-5">
              ...
              <a href="https://danilscenictours.co.ke/" className="text-blue-500" target="_blank" rel="noreferrer">See Project Here</a>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between mb-5">
            <div className="flex-grow md:mr-5">
              ...
              <a href="https://stellar-space1-tugi-ngunjiri.vercel.app/" className="text-blue-500" target="_blank" rel="noreferrer">See Project Here</a>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between mb-5">
            <div className="flex-grow md:mr-5">
              ...
              <div className="mb-2 text-sm font-semibold">React Project</div>
              <p className="mb-4 text-gray-700">
              Dada Women Wellness Initiative is a campaign that that raises awareness on women's wellness and events.
              </p>
              <a href="https://dada-golf-elxyvm21o-alexirungu-moringaschoo.vercel.app/" className="text-blue-500" target="_blank" rel="noreferrer">See Project Here</a>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between mb-5">
            <div className="flex-grow md:mr-5">
              ...
              <a href="https://communicare-revl.vercel.app/" className="text-blue-500" target="_blank" rel="noreferrer">See Project Here</a>
            </div>
            <div className="flex-shrink-0 text-primary"><span>April 2023 - May 2023</span></div>
          </div>
